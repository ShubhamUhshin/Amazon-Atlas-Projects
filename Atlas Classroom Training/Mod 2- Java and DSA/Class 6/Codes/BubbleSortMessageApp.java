...
public class BubbleSortMessageApp {
	...
	public static void main(String[] args) {
		...
		conversations[1] = m2;
		conversations[2] = new Message("Lets hangout for a code session", date3, 3, "+91 99999 33333", "+91 99999 77777");
		conversations[3] = m4;
		conversations[4] = new Message("No i am unavailable", date4, 1, "+91 99999 77777", "+91 99999 99999");
