	...
	public static void main(String[] args) {
		...
		try {
			...
			*/
			...
			//String sql = "UPDATE Customer SET name = ?, phone = ?, email = ?, cashBack = ? WHERE cid = ?";
			String sql = "SELECT * FROM Customer WHERE name like ?";
			
			PreparedStatement statement = connection.prepareStatement(sql);
			statement.setString(1, "A%");
//			statement.setString(2, "+91 90909 30303");
//			statement.setString(3, "samaira@example.com");
//			statement.setInt(4, 875);
